...
@endsection
@section('content')
<form id="amenities-form" class="mt-5 d-flex justify-content-center align-items-center" action="{{ url('account/add-3d') }}" method="POST"  enctype="multipart/form-data">
    @csrf
...
<script>
  active = document.getElementById('threed_form')
